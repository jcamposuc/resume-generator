...
const ProfilePicture = ({ profilePicture, setValue }) => {
    ...
    return (
        <figure className="relative m-auto transition-all duration-300 w-36 h-36 filter grayscale hover:grayscale-0">
            <img
                className="object-contain hover:object-scale-down w-36 h-36"
                src={profilePicture}
                alt="profile" />
            <figcaption className="absolute bottom-0 px-4 text-white left-5 hover:text-slate-800">
                <button
                    className="px-3 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-sm me-2 focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
...
const UploadPhoto = ({ setValue }) => {
    ...
    return (
        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center m-auto border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 w-36 h-36">
            <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">SVG, PNG or JPG (Recommended 150x150)</p>
            </div>
            <input
                id="dropzone-file"
                type="file"
