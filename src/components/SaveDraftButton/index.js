...
export const SaveDraftButton = () => {
    ...
    return (
        <button
            ...
            onClick={saveDraft}
            disabled={saved}
            className='inline-flex items-center justify-center w-full px-3 py-4 my-3 text-sm font-medium text-white uppercase rounded-sm md:justify-start md:w-auto md:py-2 bg-stone-700 hover:bg-stone-800 focus:ring-4 focus:outline-none focus:ring-stone-300      '>
