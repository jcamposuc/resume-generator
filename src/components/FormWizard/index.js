...
const activeClasses = {
    elem: "text-stone-800 bold text-lg",
    indicator: "border-stone-600",
};
const inactiveClasses = {
    elem: "",
    indicator: "border-gray-500",
}
...
export const FormWizard = () => {
    ...
    return (
        <ol className="flex items-center w-full p-3 mt-5 space-x-2 text-sm font-medium text-center text-gray-500 bg-white border border-gray-200 rounded-sm shadow-sm sm:text-base sm:p-4 sm:space-x-4 rtl:space-x-reverse">
