...
export const InputColor = ({ fieldName, labelText, register, control, required = true }) => {
    return (
        <div>
            <InputLabel
                fieldName={fieldName}
            ...
            <input
                type="color"
                className="block h-10 p-1 bg-white border border-gray-200 rounded-lg cursor-pointer w-14 disabled:opacity-50 disabled:pointer-events-none"
