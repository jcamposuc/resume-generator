...
const InputLabel = ({ fieldName, labelText, required }) => (
    <label
        className='mb-2 ml-0 text-sm font-medium text-gray-900 dark:text-white '
    ...
    return (
        <div>
            ...
            <input
                ...
                className="block w-full p-2 text-base text-gray-900 border border-gray-300 rounded-sm placeholder:text-xs bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                {...register(fieldName, {
                    required,
                    minLength,
                    maxLength,
...
export const InputTextarea = ({ fieldName, labelText, register, control, required = true, minLength = 2, maxLength = 400 }) => {
    return (
        <div>
            ...
            <textarea
                rows="3"
                className="block w-full p-2 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                {...register(fieldName, {
                    required,
                    minLength,
                    maxLength,
